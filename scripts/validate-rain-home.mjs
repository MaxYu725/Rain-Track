...
assert.match(home, /document\.getElementById\('sheet-handle'\)\?\.remove\(\)/);
assert.match(home, /document\.getElementById\('forecast-toggle'\)\?\.remove\(\)/);
...
console.log('Rain Home v2 integration validation passed');
