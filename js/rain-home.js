...
function injectStyles() {
  ...
  style.textContent = `
    ...
    .rain-home-chart-help{margin-top:7px;color:#535f64;font-size:.64rem}.rain-home-chart-help[hidden]{display:none}.rain-home-chart-help.is-partial{color:#9f7e59}.rain-home-meta{margin-top:13px;color:#68757b;font-size:.68rem;line-height:1.5}.rain-home-meta.is-partial{color:#d8a66f}.rain-home-meta strong{color:#94a0a6;font-weight:650}
    ...
    @media(max-width:700px){body.rain-home-v2:not(.rain-map-view) #forecast-panel .panel-inner{padding:10px 16px calc(24px + var(--safe-bottom))!important}.rain-home-location{padding:2px 0 13px}.rain-home-location-kicker{margin-bottom:4px}.rain-home-location-coord{margin-top:5px}.rain-home-summary{padding:19px 0 16px}.rain-home-verdict{font-size:clamp(1.9rem,9vw,2.7rem)}.rain-home-chart-section{padding-top:17px}.rain-home-section-head{align-items:flex-start;flex-direction:column;gap:4px;margin-bottom:7px}.rain-home-section-note{text-align:left}.rain-home-chart-summary{display:none}.rain-home-chart-wrap{padding:12px 9px 10px}.rain-home-axis-label{font-size:14px}.rain-home-axis-clock{font-size:16px}.rain-home-axis-lead{font-size:13px}.rain-home-unavailable-label{display:none}.rain-home-chart-help{font-size:.7rem}.rain-home-loading{min-height:300px}}
    @media(max-width:390px){.rain-home-axis-label{font-size:15px}.rain-home-axis-clock{font-size:17px}.rain-home-axis-lead{font-size:14px}.rain-home-chart-readout{grid-template-columns:1fr}.rain-home-readout-value{text-align:left}.rain-home-readout-unit{display:inline;margin-left:5px}}
...
function chartMarkup(points, runTime, { seriesComplete = true } = {}) {
  const width = 700;
  const height = 300;
  const pad = { left:42, right:12, top:18, bottom:60 };
  ...
  const xLabels = xLeads.map(lead => {
    ...
    if (lead === 0) return `<text x="${x}" y="${height - 35}" text-anchor="${anchor}"><tspan class="rain-home-axis-clock" x="${x}">${escapeHtml(formatClock(runTime))}</tspan><tspan class="rain-home-axis-lead" x="${x}" dy="15">基準</tspan></text>`;
    ...
    return `<text x="${x}" y="${height - 35}" text-anchor="${anchor}"><tspan class="rain-home-axis-clock" x="${x}">${escapeHtml(clock)}</tspan><tspan class="rain-home-axis-lead" x="${x}" dy="15">+${lead}</tspan></text>`;
  }).join('');
