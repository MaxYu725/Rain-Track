...
function injectStyles() {
  ...
  style.textContent = `
    ...
    @media(max-width:700px){body.rain-home-v2:not(.rain-map-view) #forecast-panel .panel-inner{padding:10px 16px calc(24px + var(--safe-bottom))!important}.rain-home-location{padding:2px 0 13px}.rain-home-location-kicker{margin-bottom:4px}.rain-home-location-coord{margin-top:5px}.rain-home-summary{padding:19px 0 16px}.rain-home-verdict{font-size:clamp(1.9rem,9vw,2.7rem)}.rain-home-chart-section{padding-top:17px}.rain-home-section-head{align-items:flex-start;flex-direction:column;gap:4px;margin-bottom:7px}.rain-home-section-note{text-align:left}.rain-home-chart-summary{margin-bottom:8px;color:#75838a;font-size:.69rem;font-weight:520}.rain-home-chart-wrap{padding:12px 9px 10px}.rain-home-axis-label{font-size:14px}.rain-home-axis-clock{font-size:16px}.rain-home-axis-lead{font-size:13px}.rain-home-unavailable-label{display:none}.rain-home-chart-help{font-size:.7rem}.rain-home-loading{min-height:300px}}
